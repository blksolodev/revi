  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="container z-10 mx-auto">
          ...
          >
            <div className="flex justify-center">
              <div className="border py-1 px-4 rounded-lg bg-primary/10 text-primary">Testimonials</div>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center max-w-3xl mx-auto bg-primary text-primary-foreground rounded-2xl p-8">
