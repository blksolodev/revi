...
export function Component({ onSubmit }: ComponentProps = {}) {
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="h-4 w-4 rounded border border-white/20 bg-white/5 checked:bg-white checked:border-white"
                    />
                    <label htmlFor="remember-me" className="text-xs text-white/60">
                      Remember me
                    </label>
                  </div>
